...
//        this.employeesMaximumSalaries();
    ...
    private void findEmployeesByFirstName() throws IOException {
        ...
        this.entityManager.createQuery("SELECT e FROM Employee AS e WHERE " +
                "e.firstName LIKE :pattern", Employee.class)
    ...
    private void removeObjectEx() {
        this.entityManager.getTransaction().begin();
        this.entityManager.createQuery("UPDATE Town SET name = LOWER(name) " +
